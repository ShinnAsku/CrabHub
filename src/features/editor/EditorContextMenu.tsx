...
export function EditorContextMenu({
  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className="popover-panel fixed z-50 border border-border rounded-lg py-1 min-w-[220px]"
        style={{
          left: pos.x,
          top: pos.y,
      ...
      >
        ...
        {onConvertDialect && sourceDialect && (
          <div className="relative">
            ...
            >
              ...
              <ChevronRight
                size={11}
                className={`transition-transform ${convertOpen ? 'rotate-90' : ''}`}
              />
            </button>
            {convertOpen && (
              <div className="pl-6">
        ...
        <div className="border-t border-border my-1" />
        {item(
          t('contextMenu.selectCurrentStatement'),
          onSelectCurrentStatement,

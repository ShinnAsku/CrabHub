...
import AddCellButton from '@/features/editor/notebook/AddCellButton'
import MarkdownCell from '@/features/editor/notebook/MarkdownCell'
import NotebookOutline from '@/features/editor/notebook/NotebookOutline'
import NotebookToolbar from '@/features/editor/notebook/NotebookToolbar'
import ParamsPanel from '@/features/editor/notebook/ParamsPanel'
import RunAllSummary from '@/features/editor/notebook/RunAllSummary'
import SqlCell from '@/features/editor/notebook/SqlCell'
...
const NotebookView: React.FC<NotebookViewProps> = ({ connectionId, onClose }) => {
  ...
  const updateCellName = useCallback((id: string, name: string) => {
    setCells(prev => prev.map(cell => (cell.id === id ? { ...cell, name } : cell)))
  }, [])
    ...
    <div className="flex flex-col h-full bg-background text-foreground">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-2">
          {runSummary && <RunAllSummary summary={runSummary} onClose={() => setRunSummary(null)} />}
        ...
        {showParams && <ParamsPanel params={params} onParamsChange={setParams} />}
      </div>
    </div>
  )
}

import { Table, Wrench, FileText, Copy, ChevronRight, Eraser, Trash2 } from 'lucide-react'
            ...
            <div className="relative group/dup">
              ...
              <div className="absolute left-full top-0 ml-0 hidden group-hover/dup:block z-[60]">
                ...
                >
                  <button
                    onClick={() => {
                      onDuplicateTable(menu.table, true)
                      onClose()
                    }}
                    className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted transition-colors"
                  >
                  ...
                  <button
                    onClick={() => {
                      onDuplicateTable(menu.table, false)
                      onClose()
                    }}
                    className="w-full flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted transition-colors"
                  >

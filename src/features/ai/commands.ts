...
import type { Message } from '@/features/ai/store'
...
export async function aiChatStream(
  ...
  const unlisten = await window.__TAURI__!.event.listen<string>('ai-stream-chunk', (event: any) => {
 ...
 */
export async function analyzeSQL(sql: string, tableName?: string): Promise<OptimizationResult> {

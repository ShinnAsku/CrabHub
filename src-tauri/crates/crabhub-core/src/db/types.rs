...
impl DatabaseType {
    pub const BUILTIN: [Self; 17] = [
        Self::PostgreSQL, Self::MySQL, Self::SQLite, Self::ClickHouse, Self::GaussDB,
        Self::Kingbase, Self::Vastbase, Self::YashanDB, Self::OceanBase, Self::TiDB,
        Self::TDSQL, Self::Oracle, Self::SQLServer, Self::DaMeng, Self::GBase,
        Self::Redis, Self::MongoDB,
    ];
...
pub struct ConnectionCapabilities {
    #[serde(flatten)]
    pub driver: DriverCapabilities,
    pub supports_script_sessions: bool,
    pub supports_interactive_transactions: bool,
}
    ...
    fn from(err: sqlx::Error) -> Self {
        match err {
            ...
            sqlx::Error::PoolTimedOut => {
                DbError::Timeout("Connection pool is busy; no statement was started".to_string())
            }
